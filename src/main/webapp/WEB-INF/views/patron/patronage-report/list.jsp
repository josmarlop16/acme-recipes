...
<acme:list>
	<acme:list-column code="inventor.patronageReport.list.label.seqNumber" path="seqNumber" width="15%"/>
	<acme:list-column code="inventor.patronageReport.list.label.creation" path="creation" width="15%"/>

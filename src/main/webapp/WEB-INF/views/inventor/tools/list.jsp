...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.tool.list.label.retailPrice" path="retailPrice" width="20%"/>
	<acme:list-column code="anonymous.tool.list.label.link" path="link" width="60%"/>
</acme:list>
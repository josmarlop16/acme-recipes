...
@Service
public class EpicurePatronageListByPatronService implements AbstractListService<Epicure, Patronage>{
	...
	public Collection<Patronage> findMany(final Request<Patronage> request) {
		...
		result = this.repository.findAllPatronagesByEpicureId(principal.getActiveRoleId());

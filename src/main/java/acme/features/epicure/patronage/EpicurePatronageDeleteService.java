...
@Service
public class EpicurePatronageDeleteService implements AbstractDeleteService<Epicure,Patronage> {
	
	@Autowired
	protected EpicureEpicurePatronageRepository repository;

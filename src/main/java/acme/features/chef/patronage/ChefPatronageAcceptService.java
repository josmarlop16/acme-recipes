...
@Service
public class ChefPatronageAcceptService implements AbstractUpdateService<Chef, Patronage>{
	...
	public void unbind(final Request<Patronage> request, final Patronage entity, final Model model) {
		...
		request.unbind(entity, model, "status", "code", "stuff", "budget", "creationMoment", "startDate", "endDate", "optionalLink", "patron.company", "patron.statement", "patron.optionalLink");
	}

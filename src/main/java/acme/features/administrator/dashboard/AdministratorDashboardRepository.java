...
//	Average 
	@Query("select c.technology,c.retailPrice.currency, avg(c.retailPrice.amount) from Component c group by c.technology,c.retailPrice.currency")
...
//	Deviation
	@Query("select c.technology,c.retailPrice.currency, stddev(c.retailPrice.amount) from Component c group by c.technology,c.retailPrice.currency")
...
//	Minimum 
	...
	@Query("select c.technology,c.retailPrice.currency, min(c.retailPrice.amount) from Component c group by c.technology,c.retailPrice.currency")
...
//	Maximum 
	@Query("select c.technology,c.retailPrice.currency, max(c.retailPrice.amount) from Component c group by c.technology,c.retailPrice.currency")
